namespace BookShopSystem.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookShopSystem.Data.BookSystemDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            AutomaticMigrationDataLossAllowed = true;
            ContextKey = "BookShopSystem.Data.BookSystemDbContext";
        }

        protected override void Seed(BookShopSystem.Data.BookSystemDbContext context)
        {
            SeedAuthors(context);
            SeedBooks(context);
